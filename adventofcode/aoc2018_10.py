data = '''position=<-30509,  41062> velocity=< 3, -4>
...
points = [Point(int(line[10:16]), int(line[18:24]), int(line[36:38]), int(line[40:42])) for line in data.splitlines()]
